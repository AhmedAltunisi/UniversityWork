...
/**
 * Represents the view's understanding of a rectangle.
 */
public class ViewRect extends AbstractViewShape {
   ...
   * @param name name
   */
  public ViewRect(int x, int y, int height, int width, Color color, String name) {
   ...
   * @param name name
   */
  public ViewRect(Position2D pos, int height, int width, Colors color, String name) {
   ...
   * @return the SVG representation of the move.
   */
